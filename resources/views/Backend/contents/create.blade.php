    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
      <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6 bg-white border-b border-gray-200">
          <h1 class="uppercase pb-4 text-blue-600">Create Announcement or Update</h1>
          <div class="mt-10 sm:mt-0">
            ...
            <div class="md:grid">
              <div class="mt-5 md:mt-0 md:col-span-2">
                <form action="{{ route('backend.contents.store') }}" method="POST" enctype="multipart/form-data">
                  @csrf
                  <div class="shadow overflow-hidden sm:rounded-md">
                    <div class="px-4 py-5 bg-white sm:p-6 mb">
                      <div class="grid grid-cols-6 gap-6 pb-3">
                        <div class="col-span-6 sm:col-span-3">
                          <picture>
                            <img src="" alt="image" class="w-100 h-40 hidden" id="imgPreview">
                          </picture>
                        </div>
                      </div>
                      <div class="grid grid-cols-6 gap-6 pb-3">
                      ...
                      <div class="grid grid-cols-6 gap-6 pb-3">
                        <div class="col-span-6 sm:col-span-3">
                          ...
                          <select id="type" name="type"
                            ...
                            <option value="{{ \App\Models\Content::ANNOUNCEMENT_TYPE }}">Announcement</option>
                            <option value="{{ \App\Models\Content::UPDATE_TYPE }}">Update</option>
                          </select>
                        </div>
                      </div>
                    ...
                    <div class="px-4 py-3 bg-gray-50 text-left sm:px-6">
                      <button type="submit"
                              ...
                              font-medium rounded-md text-white bg-blue-600 hover:bg-indigo-700 focus:outline-none
